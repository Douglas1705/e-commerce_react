...
function Carrinho() {
  ...
  return (
    <section className="container-global flex flex-col gap-5 px-5">
      ...
      <article className="flex flex-col py-5 gap-5">
        ...
        <button
          className="bg-green-600 text-white p-3 rounded-2xl text-2xl hover:bg-green-400"
          // eslint-disable-next-line react/jsx-no-bind
